package com.project.professor.alocation.configuraçao;
...
import com.project.professor.alocation.ProfessorAlocationApplication;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage(ProfessorAlocationApplication.class.getPackage().getName()))
